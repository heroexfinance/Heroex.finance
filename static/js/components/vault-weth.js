...
let {reward_token, token_weth, vault_weth, BigNumber, alertify} = window

let token_dai = token_weth
let vault_dai = vault_weth
            ...
            <div className='col-md-5 pr-0 pl-0'>
              <div className='apr-info' style={{maxWidth: '300px', float: 'right'}}>
                ...
                <div className='mt-4 mb-4 apr-info-child' style={{maxWidth: '150px'}}>
                  <p><strong className='purple-text'>YFDAI</strong> Vault <strong className='orange-text'>APR:</strong></p>
                  <p className='mb-0'><span className='orange-text'>APR-</span><span className='text-bold purple-text'>Yearly:</span> <span style={{float: 'right'}}>12<i className='orange-text'>%</i></span></p>
                  <p className='mb-0'><span className='orange-text'>APR-</span><span className='text-bold purple-text'>Monthly:</span> <span style={{float: 'right'}}>1<i className='orange-text'>%</i></span></p>
                  <p className='mb-0'><span className='orange-text'>APR-</span><span className='text-bold purple-text'>Daily:</span> <span style={{float: 'right'}}>0.033<i className='orange-text'>%</i></span></p>
                </div>
              </div>
            </div>
        </div>
...
export default class VaultDAI extends React.Component {
    ...
    handleWithdraw = (e) => {
        ...
        amount = new BigNumber(amount).times(1e18).toFixed(0)
        vault_dai.emergencyWithdraw(amount)
    }
    ...
    refreshBalance = async () => {
        ...
        try {
            ...
            depositedTokens, lastClaimedTime, stakers, contractBalance] = await Promise.all([_bal,_rBal ,_pDivs, _cliffTime, _tEarned, _stakingTime, _dTokens, _lClaimTime, _stakers, _contractBalance])
    ...
    render() {
        ...
        let {token_balance, reward_token_balance, tvlInUsd, pendingDivs, totalEarnedTokens, depositedTokens, cliffTime, stakingTime, coinbase, stakers, totalStaked} = this.state
        ...
        <div className='token-staking mb-5 mt-5'>
                ...
                <div className='col-md-6 mb-5'>
                    ...
                    <form onSubmit={this.handleClaimDivs}>
                        <div className='form-row'>
                            ...
                            <div className='col'>
                                <p className='form-control form-control-lg text-right' style={{border: 'none', paddingLeft: 0, background: 'transparent'}}><strong style={{fontSize: '1.2rem'}}>{pendingDivs}</strong> <strong className="orange-text">WETH worth YFDAI</strong></p>
                            </div>
                        </div>
                    </form>
                    ...
                    <div className='tips mt-5'>
                        ...
                        <ol>
                            <li>
                                Rewards will be distributed Daily 12.00 pm UTC.
                            </li>
                            <br />
                            <li>
            ...
            <table className='table table-borderless table-sm'>
                <tbody>
                    ...
                    <tr>
                        <th>My Balance</th>
                        <td className="text-right"><strong>{token_balance}</strong> <strong className="orange-text">WETH</strong></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>Deposited</th>
                        <td className="text-right"><strong>{depositedTokens}</strong> <strong className="orange-text">WETH</strong></td>
                    </tr>
                    {/* <tr>
                        <th>Total Earned</th>
                    ...
                    <tr>
                        <th>Total Earning</th>
                        <td className="text-right"><strong>{pendingDivs}</strong> <strong className="orange-text">WETH</strong></td>
                    </tr>
                    <tr>
                    ...
                    <tr className='tips text-normal'>
                        ...
                        <td className="text-right"><strong>{totalStaked}</strong> <strong>WETH</strong></td>
                    </tr>
                    <tr className='tips text-normal'>
                        <th>Total Users</th>
