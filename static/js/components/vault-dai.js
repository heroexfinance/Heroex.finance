...
let {reward_token, token_dai, vault_dai, BigNumber, alertify} = window
            ...
            <div className='col-md-5 pr-0 pl-0'>
              <div className='apr-info' style={{maxWidth: '300px', float: 'right'}}>
                ...
                <div className='mt-4 mb-4 apr-info-child' style={{maxWidth: '150px'}}>
                  ...
                  <p className='mb-0'><span className='orange-text'>APR-</span><span className='text-bold purple-text'>Yearly:</span> <span style={{float: 'right'}}>24<i className='orange-text'>%</i></span></p>
                  <p className='mb-0'><span className='orange-text'>APR-</span><span className='text-bold purple-text'>Monthly:</span> <span style={{float: 'right'}}>2<i className='orange-text'>%</i></span></p>
                  <p className='mb-0'><span className='orange-text'>APR-</span><span className='text-bold purple-text'>Daily:</span> <span style={{float: 'right'}}>0.066<i className='orange-text'>%</i></span></p>
                </div>
              </div>
            </div>
        </div>
        ...
        <div className='token-staking mb-5 mt-5'>
                ...
                <div className='col-md-6 mb-5'>
                    ...
                    <form onSubmit={this.handleClaimDivs}>
                        <div className='form-row'>
                            ...
                            <div className='col'>
                                <p className='form-control form-control-lg text-right' style={{border: 'none', paddingLeft: 0, background: 'transparent'}}><strong style={{fontSize: '1.2rem'}}>{pendingDivs}</strong> <strong className="orange-text">DAI worth YFDAI</strong></p>
                            </div>
                        </div>
                    </form>
            ...
            <table className='table table-borderless table-sm'>
                <tbody>
                    ...
                    <tr>
                        <th>My Balance</th>
                        <td className="text-right"><strong>{token_balance}</strong> <strong className="orange-text">DAI</strong></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>Deposited</th>
                        <td className="text-right"><strong>{depositedTokens}</strong> <strong className="orange-text">DAI</strong></td>
                    </tr>
                    {/* <tr>
                        <th>Total Earned</th>
                    ...
                    <tr>
                        <th>Total Earning</th>
                        <td className="text-right"><strong>{pendingDivs}</strong> <strong className="orange-text">DAI</strong></td>
                    </tr>
                    <tr>
                    ...
                    <tr className='tips text-normal'>
                        ...
                        <td className="text-right"><strong>{totalStaked}</strong> <strong>DAI</strong></td>
                    </tr>
                    <tr className='tips text-normal'>
                        <th>Total Users</th>
